...
i=1
while IFS="," read -r SUID JOB_FIRST JOB_LAST PARAMANGDIST PARAMSSW PARAMSSP PARAMAL PARAMNIPW PARAMNIPP PARAMDLCW
do
	...
	then
		...
		mkdir -p /scratch/hepworth/hepworth/ucnanalysis/JPARC_2024/filling/results/${SUID}
