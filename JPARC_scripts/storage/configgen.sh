...
i=1
while IFS="," read -r SUID JOB_FIRST JOB_LAST PARAMVALVEOPENTIME PARAMTOTALSIMTIME PARAMSSW PARAMSSP PARAMAL PARAMNIPW PARAMNIPP PARAMDLCW 
...
do
	...
	then
		...
		perl -pi -e "s/#PARAMVALVEOPENTIME/${PARAMVALVEOPENTIME}/g" "configs/config_${SUID}.in"
		perl -pi -e "s/#PARAMTOTALSIMTIME/${PARAMTOTALSIMTIME}/g" "configs/config_${SUID}.in"
		perl -pi -e "s/#PARAMDLCW/${PARAMDLCW}/g" "configs/config_${SUID}.in"
		
		# Create a directory for the results
		mkdir /scratch/hepworth/hepworth/ucnanalysis/JPARC_2024/storage/results/$SUID
		...
		rm "/project/6006407/hepworth/ucnanalysis/JPARC_2024/storage/configs/batch/batch_${SUID}.sh"
		cp batch_template.sh "/project/6006407/hepworth/ucnanalysis/JPARC_2024/storage/configs/batch/batch_${SUID}.sh"
		perl -pi -e "s/#SUID/${SUID}/g" "/project/6006407/hepworth/ucnanalysis/JPARC_2024/storage/configs/batch/batch_${SUID}.sh"
		perl -pi -e "s/#JOB_FIRST/${JOB_FIRST}/g" "/project/6006407/hepworth/ucnanalysis/JPARC_2024/storage/configs/batch/batch_${SUID}.sh"
		perl -pi -e "s/#JOB_LAST/${JOB_LAST}/g" "/project/6006407/hepworth/ucnanalysis/JPARC_2024/storage/configs/batch/batch_${SUID}.sh"
		cd "/project/6006407/hepworth/ucnanalysis/JPARC_2024/storage/configs/batch"
